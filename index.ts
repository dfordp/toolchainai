...
/**
 * Enhanced toolchainai configuration interface
 */
export interface ToolChainAIConfig {
  // LLM Configuration
...
/**
 * Create a toolchainai instance with enhanced configuration
 */
function createToolChainAI(config: ToolChainAIConfig): LLMBase {
...
// Main toolchainai object with both old and new API
const toolchainai = Object.assign(createToolChainAI, {
  llm: {
...
export default toolchainai;

// Export the enhanced toolchainai function  
export { createToolChainAI as toolchainai };
